...
const HEADER_FILE_PATH: &str = "redis/src/dict.h";
const SOURCE_FILE_PATH: &str = "redis/src/dict.c";
...
fn compile_helpers() {
    ...
    compile_redis_objects_and_link_into_a_library(
        ...
        &[
            SOURCE_FILE_PATH,
            "redis/src/redisassert.c",
            "redis/src/siphash.c",
            "redis/src/zmalloc.c",
            "redis/src/util.c",
            "redis/deps/fpconv/fpconv_dtoa.c",
        ],
        &include_dirs,
        &libdir_path,
    );
